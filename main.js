...
node2.textContent = "I used the getElementClassName(\"node2\") method to access this";
...
parent.textContent = "This node was created using the createElement() method";
...
let child = document.createElement("parent");
